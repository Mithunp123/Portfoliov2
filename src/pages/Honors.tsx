    ...
    <div className="w-full max-w-5xl mx-auto px-4 md:px-6 space-y-16 overflow-hidden">
      ...
      <section className="pt-8 lg:pt-0 space-y-6">
        ...
        <div className="space-y-3">
          ...
          <h1 className="text-5xl md:text-8xl font-extrabold uppercase tracking-tight leading-none text-[var(--text-primary)] select-none" style={{ fontFamily: "'Syne', sans-serif" }}>
            Credentials
          </h1>
          ...
          <p className="text-[var(--text-secondary)] text-sm md:text-base leading-relaxed max-w-xl font-medium font-body-md pt-1">
      ...
      <section className="border border-[var(--border-medium)] rounded-[2.5rem] bg-[var(--bg-card)] backdrop-blur-md overflow-hidden grid grid-cols-2 md:grid-cols-4 divide-x divide-y md:divide-y-0 divide-[var(--border-medium)]">
        {[
      ...
      <section className="space-y-8 relative">
        <div className="border-b border-[var(--border-strong)] pb-4">
          <h2 className="text-3xl font-extrabold text-[var(--text-primary)] uppercase tracking-tight" style={{ fontFamily: "'Syne', sans-serif" }}>
            Verification Tree
          </h2>
        </div>
            ...
            {timelineData.map((group, gIdx) => (
              <div key={gIdx} className="relative space-y-6">
                ...
                <div className="flex items-center gap-4 relative">
                  ...
                  <div 
                    className="absolute left-[-24px] md:left-[-38px] w-4 h-4 rounded-full bg-[var(--bg-primary)] border-2 flex items-center justify-center z-10 transition-transform duration-300 hover:scale-125"
                  ...
                  <h3 
                    className="text-2xl font-black text-[var(--text-primary)] uppercase tracking-wider font-mono select-none" 
                ...
                <div className="space-y-4 pl-4 md:pl-6 relative">
                  {group.certificates.map((cert, cIdx) => (
                    <div key={cIdx} className="relative w-full">
                      ...
                      <div className="absolute left-[-24px] md:left-[-32px] top-1/2 w-4 md:w-8 h-[2px] bg-[var(--border-medium)] pointer-events-none"></div>
                      ...
                      >
                        <div 
                          className="w-full bg-[var(--bg-card)] hover:bg-[var(--bg-card-hover)] border border-[var(--border-subtle)] hover:border-[var(--border-medium)] rounded-2xl p-4 sm:p-5 flex items-center justify-between gap-4 transition-all duration-500 relative overflow-hidden group shadow-lg"
                        ...
                        >
                          ...
                          <div className="pl-2 space-y-2 min-w-0 flex-1">
                            <div className="flex flex-wrap items-center gap-2">
                              ...
                              <span className="text-[8.5px] uppercase tracking-widest text-[var(--text-muted)] font-extrabold font-mono" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>
                                {cert.issuer}
                              </span>
                            </div>
                            ...
                            <div className="flex flex-wrap gap-1.5 pt-1">
                              {cert.skills.map((skill, sIdx) => (
                                <span 
                                  key={sIdx}
                                  className="text-[7.5px] font-mono tracking-wider text-[var(--text-secondary)] bg-[var(--bg-black-overlay)] border border-[var(--border-subtle)] px-2 py-0.5 rounded-md"
                                  style={{ fontFamily: "'Space Grotesk', sans-serif" }}
                                >
                                  {skill}
                                </span>
      ...
      {/* 5. Footer */}
      <footer className="pt-8 border-t border-[var(--border-subtle)] flex flex-col md:flex-row justify-between items-center text-[var(--text-dim)] text-[10px] font-extrabold uppercase tracking-[0.2em] gap-4 font-mono" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>
        <p>© 2026 Mithun P. Crafted with React &amp; Tailwind CSS</p>
        <div className="flex space-x-8">
          <a className="hover:text-[var(--text-primary)] transition-colors duration-300" href="https://github.com/Mithunp123/" target="_blank" rel="noopener noreferrer">GitHub</a>
          <a className="hover:text-[var(--text-primary)] transition-colors duration-300" href="https://linkedin.com/in/mithun-p2006/" target="_blank" rel="noopener noreferrer">LinkedIn</a>
        </div>
      </footer>
    </div>
  );
