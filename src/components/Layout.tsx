    ...
    <div className="min-h-screen relative bg-[var(--bg-primary)] text-[var(--text-primary)]">
      ...
      <div className="fixed left-6 top-1/2 -translate-y-1/2 z-[20] hidden lg:flex flex-col gap-6 items-center px-3.5 py-6 rounded-full glass-card shadow-2xl transition-all duration-300 hover:border-[#3b82f6]/30">
        ...
        <a 
          ...
          className="text-[var(--text-secondary)] hover:text-[var(--text-primary)] transition-all duration-300 relative group flex items-center justify-center p-2 rounded-full hover:bg-[var(--border-medium)] hover:shadow-[0_0_15px_rgba(255,255,255,0.2)]"
        >
        ...
        <a 
          ...
          target="_blank" 
          rel="noopener noreferrer"
          className="text-[var(--text-secondary)] hover:text-[#0077b5] transition-all duration-300 relative group flex items-center justify-center p-2 rounded-full hover:bg-[#0077b5]/10 hover:shadow-[0_0_15px_rgba(0,119,181,0.3)]"
        >
          <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
        ...
        <a 
          ...
          target="_blank" 
          rel="noopener noreferrer"
          className="text-[var(--text-secondary)] hover:text-[#25d366] transition-all duration-300 relative group flex items-center justify-center p-2 rounded-full hover:bg-[#25d366]/10 hover:shadow-[0_0_15px_rgba(37,211,102,0.3)]"
        >
          <LottieLoader 
